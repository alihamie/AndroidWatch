...
public class AndroidGraphics implements Graphics {
    ...
    public void drawArc(float x, float y, float width, float height, float startAngle,
        ...
        canvas.drawArc(x,y,width+x,height+y,startAngle,sweepAngle,useCenter,paint);
    }
    ...
    @Override
    public void fillArc(RectF oval, float startAngle, float sweepAngle, boolean useCenter, int color){
        paint.setColor(color);
        paint.setStyle(Style.FILL);
